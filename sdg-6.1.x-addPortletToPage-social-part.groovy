...
Layout layoutActivities = LayoutLocalServiceUtil.getFriendlyURLLayout(
...
Layout layoutStatistics = LayoutLocalServiceUtil.getFriendlyURLLayout(
...
Layout layoutRequests = LayoutLocalServiceUtil.getFriendlyURLLayout(
